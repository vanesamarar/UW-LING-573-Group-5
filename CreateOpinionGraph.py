...
## The rest is directly downloaded from Opinosis repo -- to be deleted prior to submission
...
# To be modified based on the file location
fileName = "./topics/gas_mileage_toyota_camry_2007.txt.data"
...
means = dict(zip(vectorizer.get_feature_names_out(), means.tolist()[0]))
